...
const socialLinks = [
  {
    href: "https://github.com/Shiro-root",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://web.facebook.com/profile.php?id=100013816023808",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        ...
        fill="#3b5998"
      >
        <path d="M22.675 0H1.325C.592 0 0 .592 0 1.325v21.351C0 23.408.592 24 1.325 24h21.351C23.408 24 24 23.408 24 22.675V1.325C24 .592 23.408 0 22.675 0zm-2.628 12.61h-4.047v11.331h-4.05V12.61h-2.488v-3.57h2.487V7.21c0-2.536 1.458-3.91 3.657-3.91 1.06 0 2.141.188 2.141.188v2.42h-1.207c-1.127 0-1.476.699-1.476 1.413v1.694h2.859l-.458 3.57z" />
      </svg>
    ),
    alt: "Facebook",
  },
  {
    href: "https://www.instagram.com/dewanggatirta_",
    icon: (
      <svg
        width="25"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bvrevggb"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="name"
                required
                placeholder="Dewangga Tirta Kencana"
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="Dewangga@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
